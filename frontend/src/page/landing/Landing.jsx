        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <div style={{ display: 'grid', gap: 32, alignItems: 'center' }} className="hero-grid">
            ...
            <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.4, ease: [0.22, 1, 0.36, 1] }} style={{ position: 'relative' }}>
              <div style={{ position: 'relative', borderRadius: 40, background: 'var(--green-100)', minHeight: 520, padding: 20 }}>
                ...
                <div style={{ position: 'absolute', left: 14, bottom: 84, background: '#fff', borderRadius: 16, padding: '10px 12px', boxShadow: 'var(--shadow-md)' }}>
                ...
                <div style={{ maxWidth: 360, margin: '52px auto 0' }}>
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.5, ease: [0.22, 1, 0.36, 1] }} style={{ marginTop: 32, maxWidth: 680, marginInline: 'auto' }}>
            <div style={{ borderRadius: 999, height: 60, background: '#fff', border: '1.5px solid var(--border)', boxShadow: 'var(--shadow-md)', display: 'flex', alignItems: 'center', padding: '0 8px 0 16px', gap: 10 }}>
            ...
            <div style={{ marginTop: 10, textAlign: 'center', color: 'var(--text-muted)', fontSize: 12, fontWeight: 500 }}>
              Try:
              {chips.map((chip) => (
