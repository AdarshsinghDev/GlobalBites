    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-green-50 text-gray-800 p-4">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-orange-600 via-amber-500 to-green-600 bg-clip-text text-transparent mb-2">
            Kitchen Settings
          </h1>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-white/20">
          ...
          <div className="p-8 md:p-12 space-y-10">
            ...
            <div className="bg-gradient-to-r from-cyan-50 to-blue-50 rounded-2xl p-8 border border-cyan-100">
              <div className="flex items-center gap-3 mb-6">
                <div className="bg-cyan-500 p-3 rounded-xl text-white text-xl">
                  🌐
                </div>
                <h3 className="text-2xl font-bold text-gray-800">
                  Social Accounts
            ...
            <div className="bg-gradient-to-r from-gray-50 to-slate-50 rounded-2xl p-8 border border-gray-200">
              <div className="flex items-center gap-3 mb-6">
                <div className="bg-gray-500 p-3 rounded-xl text-white text-xl">
                  📋
                </div>
                <h3 className="text-2xl font-bold text-gray-800">
                  Privacy & Terms
